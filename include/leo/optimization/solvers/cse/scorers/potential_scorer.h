...
private:
    ...
    int getSavingVecVec(const std::vector<int>& column1, const std::vector<int>& column2) const;
    int getSavingVecCol(const std::vector<int>& column, const std::vector<std::vector<int>>& matrix, size_t variable) const;
    int getSavingColCol(const std::vector<std::vector<int>>& matrix, size_t variable1, size_t variable2) const;
